	...
	return (
		<>
			...
			<div className={`${classes.story} `}>
				...
				<div className={classes.story__text}>
					<h3 className='font-bold mb-2'>
						Junior Shopify Developer -- Charle Shopify Agency{' '}
						<span className='font-medium text-gray-600 opacity-80 absolute right-0'> August - October 2021</span>
					</h3>
					<p>
						Building e-commerce websites specialising in Shopify to assist clients to drive sales, manage day to day maintenance etc.
						<br />
						Experience with the fundamental programming languages mixed with Liquid, Ruby, and Tailwind. Future proof sites with best-practices code
