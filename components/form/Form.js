			...
			<section className='bg-gradient-to-br from-red-500 to-red-600 py-52'>
				<div className='flex justify-center items-center bg-gray-100 rounded-md m-auto max-w-6xl text-center'>
					<div className=' w-full pt-8 bg-white rounded-l-md shadow-2xl'>
						...
						<h2 className='mt-6 max-w-sm m-auto'>If you would like to have a chat about job offers and/or find out more about me.</h2>
						<div className='grid grid-cols-4 w-52 m-auto py-10'>
							...
							<div className='col-span-1 '>
								<ExternalLink href='https://www.facebook.com/Stockbridge123/'>
									<img className='h-10 rounded-md' src='https://upload.wikimedia.org/wikipedia/commons/c/cd/Facebook_logo_%28square%29.png' alt='' />
								</ExternalLink>
							</div>
